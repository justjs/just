...
test('lib/fill.js', {'autoend': true}, function (t) {
	...
	t.test('Should left the structure intact if there\'s no data ' +
		'to add.', function (st) {
	...
	t.test('Should fill with `undefined` values.', function (st) {
